...
{ 
 ...
 $erFlag="Login"; }
elseif($this->session->flashdata('successReset') || $this->session->flashdata('errorReset')){ 
   $erFlag="Forget_password";
 } 
?>
  <script type="text/javascript">
   jQuery(document).ready(function($) {
      ...
      if(erFlag!=="0"){
        ...
        else if(erFlag=="Login")
        {
          $("#login-modal").modal('show');
        }
        else if(erFlag=="Forget_password")
        {
          $(".forgot-pwd").trigger('click');
          $("#login-modal").modal('show');
        }
      }
    });
