    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <a href="<?php echo base_url(); ?>" class="logo"><img src="<?php echo base_url('assets/images/logo.png'); ?>" alt="Impression Bridal" class="img-responsive" align="center"></a>
            ...
            <ul class="menu">
              ...
              <li>
                ...
                <ul>
                    ...
                    <li><a href="<?php echo base_url('impression/collection/2'); ?>"><?php echo $colletionp[2]; ?></a></li>
