            ...
            <div class="panel-heading">
                <div class="page-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('admin/story_list'); ?>">Stories List</a></li>
                    ...
                    <div class="col-sm-12 col-md-12 mt-20">
                        <?php $arr=array('class'=>"form-horizontal");
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <img src="<?php echo 'https://res.cloudinary.com/'.CLOUDNARYNAME.'/image/upload/c_fill,g_faces:center,h_400/'.$image['doc_path'] ?>" class="img-responsive">
