                    ...
                    <?php } ?>
                        <?php $arr=array('class'=>"form-horizontal");
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-xl-10">
                                    <input type="text" class="form-control" name="link_desc" placeholder="Enter Link" value="<?php if(isset($link_details->link_desc) && strlen(trim($link_details->link_desc))) { echo html_escape($link_details->link_desc); } ?>"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Image Link" class ="form-control-label col-sm-3 col-xl-2">Image Link</label>
                                <div class="col-sm-9 col-xl-10">
                                    <input type="text" class="form-control" name="image" placeholder="Enter image link" value="<?php if(isset($link_details->image) && strlen(trim($link_details->image))) { echo html_escape($link_details->image); } ?>"/>
                                </div>
                            </div>
