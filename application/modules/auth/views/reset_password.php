...
<head>
    ...
    <title>Reset Password | Impression Bridal</title>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <?php $arr=array('id'=>"LoginForm");
                            echo form_open('auth/update_password',$arr); ?>
                    <div class="form-group form-material floating" data-plugin="formMaterial">
                        <input type="password" required="" class="form-control" id="inputEmail" name="password" placeholder="Enter New Password">
                        <label class="floating-label">Enter New Password</label>
                    </div>
                    <div class="form-group form-material floating" data-plugin="formMaterial">
                        <input type="password" required="" class="form-control" id="inputPassword" name="confirm_password" placeholder="Confirm Password">
                        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
                        <label class="floating-label">Confirm Password</label>
                    </div>
                    <button type="submit" class="btn btn-primary btn-block btn-lg mt-20">Reset password</button>
                    <?php echo form_close(); ?>
