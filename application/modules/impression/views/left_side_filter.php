            ...
            <h5>Collections</h5>
                <ul>
                    ...
                    <?php foreach ($brands_list as $key => $value) { ?>
                     <li><div class="radio"><input id="<?php echo $value->brand_id; ?>" class="cradio ml-0" type="radio" name="brand_id" data-style="brand" data-id="<?php echo $value->brand_id; ?>"><label for="<?php echo $value->brand_id; ?>"><?php echo $value->brand_name; ?></label></div></li>
                    <?php } ?>
