        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                ...
                <div class="row">
                    ...
                    <?php } ?>
                            <div class="pro-wrap">
                                <a href="<?php echo base_url('impression/collection/'.$collection['collection_id']);?>"><img src="<?php echo "https://res.cloudinary.com/".CLOUDNARYNAME."/image/upload/".$collection['doc_path']; ?>" class="img-responsive"></a>
