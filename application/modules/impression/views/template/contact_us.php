...
<head>
	<meta charset="utf-8" />
	<title>Impression Bridal | Contact Us</title>
                                            ...
                                            <table class="six columns">
                                                <tr>
                                                    <td class="text-right valign-middle">
                                                        <span class="template-label">Contact Us - Form</span>
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </table>
                                    ...
                                    <td class="wrapper">
                                        <table class="twelve columns">
                                            <tr>
                                                <td class="last">
                                                    <h4>Contact.</h4>
                                                    <p class="m-b-5">Lorem Ipsum is simply dummy text of the printing and:</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="panel">
												
                                                    Follow This link to login to your account <a href="<?php echo  base_url(); ?>"><?php echo site_url(); ?></a><br/>
