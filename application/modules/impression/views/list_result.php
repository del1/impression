            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               <form class="navbar-form" role="search">
                  <div class="input-group add-on">
                     <input class="form-control" placeholder="Search by style number" name="srch-term" type="text">
            ...
            <div class="gallery-product col-lg-3 col-md-3 col-sm-3 col-xs-12">
               <div class="pro-wrap">
                  ...
                  <?php if(isset($product_image_array[$product->product_id])){
                     ...
                     $img_src="http://res.cloudinary.com/dm0zshykp/image/upload/c_fill,g_faces:center,h_400,w_300/v1506424026/10553C_fzbhdp.jpg";
                  } ?>
